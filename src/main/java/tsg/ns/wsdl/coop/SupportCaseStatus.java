 ...
 *         &lt;element name="stage" type="{urn:types.support_2022_2.lists.webservices.netsuite.com}SupportCaseStatusStage" minOccurs="0"/&gt;
...
@XmlType(name = "SupportCaseStatus", namespace = "urn:support_2022_2.lists.webservices.netsuite.com", propOrder = {
    "name",
    "insertBefore",
    "stage",
    "caseOnHold",
