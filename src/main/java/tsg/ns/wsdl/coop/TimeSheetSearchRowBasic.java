 ...
 *         &lt;element name="totalHours" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "TimeSheetSearchRowBasic", namespace = "urn:common_2022_2.platform.webservices.netsuite.com", propOrder = {
    "approvalStatus",
    "employee",
    "endDate",
    "externalId",
