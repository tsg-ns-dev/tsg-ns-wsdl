 ...
 *         &lt;element name="parentNexus" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnSelectField" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="taxAgency" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnSelectField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="taxDateFromFulfillment" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "NexusSearchRowBasic", namespace = "urn:common_2022_2.platform.webservices.netsuite.com", propOrder = {
    "country",
    "description",
    "externalId",
    "internalId",
    ...
    extends SearchRowBasic
{
    ...
    protected List<SearchColumnBooleanField> taxDateFromFulfillment;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the taxDateFromFulfillment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTaxDateFromFulfillment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SearchColumnBooleanField> getTaxDateFromFulfillment() {
        if (taxDateFromFulfillment == null) {
            taxDateFromFulfillment = new ArrayList<SearchColumnBooleanField>();
        }
