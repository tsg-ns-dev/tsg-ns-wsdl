 ...
 *         &lt;element name="source" type="{urn:types.common_2022_2.platform.webservices.netsuite.com}LandedCostSource" minOccurs="0"/&gt;
...
@XmlType(name = "LandedCostSummary", namespace = "urn:common_2022_2.platform.webservices.netsuite.com", propOrder = {
    "category",
    "amount",
    "source",
    "transaction"
