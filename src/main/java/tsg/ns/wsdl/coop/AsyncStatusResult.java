 ...
 *         &lt;element name="status" type="{urn:types.core_2022_2.platform.webservices.netsuite.com}AsyncStatusType"/&gt;
...
@XmlType(name = "AsyncStatusResult", namespace = "urn:core_2022_2.platform.webservices.netsuite.com", propOrder = {
    "jobId",
    "status",
    "percentCompleted",
