 ...
 *     &lt;enumeration value="_resourceGroup"/&gt;
 ...
 * 
 */
@XmlType(name = "EntityType", namespace = "urn:types.relationships_2022_2.lists.webservices.netsuite.com")
@XmlEnum
public enum EntityType {
    ...
    PARTNER("_partner"),
    @XmlEnumValue("_resourceGroup")
    RESOURCE_GROUP("_resourceGroup"),
