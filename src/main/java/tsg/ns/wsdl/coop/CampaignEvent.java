 ...
 *         &lt;element name="status" type="{urn:types.marketing_2022_2.lists.webservices.netsuite.com}CampaignCampaignEventStatus" minOccurs="0"/&gt;
...
@XmlType(name = "CampaignEvent", namespace = "urn:marketing_2022_2.lists.webservices.netsuite.com", propOrder = {
    "internalId",
    "campaignGroup",
    "description",
    "subscription",
