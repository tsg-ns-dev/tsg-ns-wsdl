 ...
 *         &lt;element name="rejectionNote" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="supervisorApproval" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="temporaryLocalJurisdiction" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="temporaryStateJurisdiction" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnStringField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="timeModified" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="timeSheet" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnSelectField" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "TimeBillSearchRowBasic", namespace = "urn:common_2022_2.platform.webservices.netsuite.com", propOrder = {
    "approvalStatus",
    "_break",
    "clazz",
    "customer",
    ...
    extends SearchRowBasic
{
    ...
    protected List<SearchColumnBooleanField> timeModified;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the timeModified property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTimeModified().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SearchColumnBooleanField> getTimeModified() {
        if (timeModified == null) {
            timeModified = new ArrayList<SearchColumnBooleanField>();
        }
