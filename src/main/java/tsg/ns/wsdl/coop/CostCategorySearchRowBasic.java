 ...
 *         &lt;element name="itemCostType" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnEnumSelectField" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "CostCategorySearchRowBasic", namespace = "urn:common_2022_2.platform.webservices.netsuite.com", propOrder = {
    "account",
    "externalId",
    "internalId",
    "isInactive",
