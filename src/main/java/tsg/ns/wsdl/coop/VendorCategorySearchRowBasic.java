 ...
 *         &lt;element name="isTaxAgency" type="{urn:core_2022_2.platform.webservices.netsuite.com}SearchColumnBooleanField" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "VendorCategorySearchRowBasic", namespace = "urn:common_2022_2.platform.webservices.netsuite.com", propOrder = {
    "externalId",
    "internalId",
    "isInactive",
    "isTaxAgency",
