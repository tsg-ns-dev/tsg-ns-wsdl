 ...
 * 
 */
@XmlType(name = "CampaignResponse", namespace = "urn:types.marketing_2022_2.lists.webservices.netsuite.com")
@XmlEnum
public enum CampaignResponse2 {
    ...
    public static CampaignResponse2 fromValue(String v) {
        for (CampaignResponse2 c: CampaignResponse2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
