...
/**
 * <p>Java class for CustomerDepositPaymentOperation.
 * 
 ...
 * 
 */
@XmlType(name = "CustomerDepositPaymentOperation", namespace = "urn:types.customers_2022_1.transactions.webservices.netsuite.com")
@XmlEnum
public enum CustomerDepositPaymentOperation {
    ...
    CustomerDepositPaymentOperation(String v) {
        value = v;
    }
    ...
    public static CustomerDepositPaymentOperation fromValue(String v) {
        for (CustomerDepositPaymentOperation c: CustomerDepositPaymentOperation.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
